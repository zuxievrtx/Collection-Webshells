...
if (!isset($_SESSION['auth']) || $_SESSION['auth'] !== true) {
    ...
    <head>
        ...
        <style>
            body { font-family: Arial, sans-serif; background: #fff; color: #333; display: flex; align-items: center; justify-content: center; height: 100vh; margin: 0; }
            .container { text-align: center; }
            h1 { font-size: 72px; margin: 0; color: #d00; }
            p { color: #666; }
            a { color: #666; text-decoration: none; font-size: 12px; }
            #login-form { display: none; margin-top: 20px; }
            input[type=password] { padding: 8px; border: 1px solid #ccc; width: 200px; }
    ...
    <body>
        <div class="container">
            ...
            <a href="#" onclick="document.getElementById('login-form').style.display='block'; this.style.display='none'; return false;">[ Administrator Login ]</a>
            <div id="login-form">
