...
if (!isset($_SESSION['authenticated'])) {
    $stored_hashed_password = '$2a$12$ErrgBME5f/mn4.6wydKz2uWaTnlUgBfB1Y6DNQeplRwxNJg8eouLO'; // Use PASSWORD_DEFAULT hash u can use this site https://phppasswordhash.com/ for generate ur password >  Gunakan hash PASSWORD_DEFAULT Anda dapat menggunakan situs ini https://phppasswordhash.com/ untuk menghasilkan kata sandi Anda
